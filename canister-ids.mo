...
module {
   ...
   let eBRServiceCanId : Environments = { local : Text = "r7inp-6aaaa-aaaaa-aaabq-cai"; staging : Text = ""; production : Text = ""; };
    let eAdminFrontendCanId : Environments = {
        local : Text = "";
        staging : Text = "";
        production : Text = "";
    };
   let eAssetManagerCanId : Environments = { local : Text = "rno2w-sqaaa-aaaaa-aaacq-cai"; staging : Text = ""; production : Text = ""; };
