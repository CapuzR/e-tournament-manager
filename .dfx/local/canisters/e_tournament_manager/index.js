...
import { idlFactory } from './e_tournament_manager.did.js';
export { idlFactory } from './e_tournament_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.E_TOURNAMENT_MANAGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./e_tournament_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the e_tournament_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./e_tournament_manager.did.js")._SERVICE>}
 */
export const e_tournament_manager = createActor(canisterId);
