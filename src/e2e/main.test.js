...
describe('Tournaments', () => {
    beforeEach(async () => {
        ...
        let tournamentArgs = {
            ...
            internalCollections: [
                ...
                {
                    id: "zejmq-rqaaa-aaaah-qcnsq-cai",
                    name: "Interitus"
                }
            ],
            description: "Test",
    ...
    describe('No external collections', () => {
        ...
        test("Should create Tounament, play a match, check leaderboard and return 1 player.", async () => {
            ...
            let endMatch = await bRTM.endMatch(eMI, playersStats, 1);
            console.log(addTRes.ok);
        ...
        test.skip("Should create 2 Tounaments, play 2 matches, check leaderboard and return 2 players.", async () => {
